...
#ifndef COMMENTPASSTHROUGH_H_
#define COMMENTPASSTHROUGH_H_
 ...
 */
class CommentPassThrough : public DoxygenTranslator {
public:
  CommentPassThrough(bool debugTranslator = false, bool debugParser = false);
...
protected:
   ...
   */
  typedef void (CommentPassThrough::*tagHandler)(DoxygenEntity &tag,
