...
#ifndef PYDOCCOPIER_H_
#define PYDOCCOPIER_H_
...
class PyDocCopier : public DoxygenTranslator {
public:
    PyDocCopier(bool debugTranslator = false, bool debugParser = false);
...
protected:
     ...
     */
    typedef void (PyDocCopier::*tagHandler)(DoxygenEntity &tag,
    ...
    void handleTagInclude(DoxygenEntity &tag, std::string &translatedComment, std::string &arg);
    /*
